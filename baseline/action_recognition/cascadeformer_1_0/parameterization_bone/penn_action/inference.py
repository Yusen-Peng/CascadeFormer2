...
def main():
    ...
    if unfreeze_layers is None:
        ...
        t1 = load_T1("action_checkpoints/Penn_pretrained.pt", d_model=hidden_size, num_joints=NUM_JOINTS_PENN, nhead=n_heads, num_layers=num_layers, device=device)
    else:
        t1 = load_T1("action_checkpoints/Penn_finetuned_T1.pt", d_model=hidden_size, num_joints=NUM_JOINTS_PENN, nhead=n_heads, num_layers=num_layers, device=device)
